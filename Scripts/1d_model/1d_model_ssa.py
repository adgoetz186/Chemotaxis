...
run_dict = {"L0":{"repeat":10,"L_init":0},"L001":{"repeat":10,"L_init":0.01},"L01":{"repeat":10,"L_init":0.1},"L05":{"repeat":10,"L_init":0.5},"L1":{"repeat":10,"L_init":1}}
...
for i in range(len(run_batch_list)):
    ...
    run_dataframe.to_csv(f"data/Simulations_1d_diff_stoch/{run_batch_list[i]}/{run_batch_list[i]}_{len(os.listdir(f'data/Simulations_1d_diff_stoch/{run_batch_list[i]}'))}")
    print(result.dataframe)
